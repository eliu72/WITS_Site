...
class Alumnus
{
  ...
  const CLASS_TYPE = "Alumnus";
  const IMAGE_PATH = ALUMNI_IMAGE_PATH;
  ...
  * @return Alumnus|false The event object, or false if the record was not found or there was a problem
  */
