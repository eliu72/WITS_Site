    ...
    <div class="row">
        ...
        <div class="col-10">
          ...
          <form action="admin.php?action=<?php echo $results['formAction']?>" method="post"  enctype="multipart/form-data" onsubmit="closeKeepAlive()">
                  <input type="hidden" name="mentorId" value="<?php echo $results['mentor']->id ?>"/>
          ...
          <?php } ?>
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <input type="text" name="person" id="person" placeholder="Name of the mentor" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['mentor']->person )?>" />
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">Mentor Position</label>
                </div>
                <div class="col-7">
                <textarea name="title" id="title" placeholder="Position of the mentor" required maxlength="255" style="width:100%"><?php echo htmlspecialchars( $results['mentor']->title )?></textarea>
                </div>
              </div>
              <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="summary" id="summary" placeholder="Brief description of the mentor" required maxlength="500" style="width:100%;height: 5em;"><?php echo htmlspecialchars( $results['mentor']->summary )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="url" id="url" placeholder="URL to LinkedIn or website" required maxlength="500" style="width:100%; height: 5em;"><?php echo htmlspecialchars( $results['mentor']->url )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="author" id="author" placeholder="Your name" required maxlength="255" style="width:100%;"><?php echo htmlspecialchars( $results['mentor']->author )?></textarea>
                </div>
              </div>
              <br>

              <?php if ( $results['mentor'] && $imagePath = $results['mentor']->getImagePath() ) { ?>
                ...
                <div class="row mx-auto">
                  ...
                  <div class="col-2">
                  <img id="mentorImage" src="<?php echo $imagePath ?>" alt="Mentor Image" style="width:150px;"/>
                  </div>
                  <div class="col-2 my-auto">
            ...
            <?php if ( $results['mentor']->id ) { ?>
                  <p><a href="admin.php?action=deleteMentor&amp;mentorId=<?php echo $results['mentor']->id ?>" onclick="return confirm('Delete This Mentor?')"><h3><b>Delete This Mentor</b></h3></a></p>
            <?php } ?>
