    ...
    <div class="row">
        ...
        <div class="col-10">
          ...
          <form action="admin.php?action=<?php echo $results['formAction']?>" method="post"  enctype="multipart/form-data" onsubmit="closeKeepAlive()">
                  <input type="hidden" name="witsMemberId" value="<?php echo $results['witsMember']->id ?>"/>
          ...
          <?php } ?>
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">WITS Member Name</label>
                </div>
                <div class="col-7">
                <input type="text" name="person" id="person" placeholder="Name of the wits member" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['witsMember']->person )?>" />
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">WITS Member Position</label>
                </div>
                <div class="col-7">
                <textarea name="title" id="title" placeholder="Position of the wits member" required maxlength="255" style="width:100%"><?php echo htmlspecialchars( $results['witsMember']->title )?></textarea>
                </div>
              </div>
              <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="summary" id="summary" placeholder="Brief description of the wits member" required maxlength="500" style="width:100%;height: 5em;"><?php echo htmlspecialchars( $results['witsMember']->summary )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="url" id="url" placeholder="URL to LinkedIn or website" required maxlength="500" style="width:100%; height: 5em;"><?php echo htmlspecialchars( $results['witsMember']->url )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="author" id="author" placeholder="Your name" required maxlength="255" style="width:100%;"><?php echo htmlspecialchars( $results['witsMember']->author )?></textarea>
                </div>
              </div>
              <br>

              <?php if ( $results['witsMember'] && $imagePath = $results['witsMember']->getImagePath() ) { ?>
                ...
                <div class="row mx-auto">
                  ...
                  <div class="col-2">
                  <img id="witsMemberImage" src="<?php echo $imagePath ?>" alt="wits member Image" style="width:150px;" />
                  </div>
                  <div class="col-2 my-auto">
            ...
            <?php if ( $results['witsMember']->id ) { ?>
                  <p><a href="admin.php?action=deleteWitsMember&amp;witsMemberId=<?php echo $results['witsMember']->id ?>" onclick="return confirm('Delete This WITS Member?')"><h3><b>Delete This WITS Member</b></h3></a></p>
            <?php } ?>
          </div>
        </div>
      </div>
