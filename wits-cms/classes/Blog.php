...
class Blog
{
   ...
   */
  const DB_NAME = "blogs";
  const CLASS_TYPE = "Blog";
  const IMAGE_PATH = BLOGS_IMAGE_PATH;

  /**
  * @var int The Blog ID from the database
  */
  public $id = null;

  /**
  * @var string Full title of the Blog
  */
  public $title = null;

  /**
  * @var string A short summary of the Blog
  */
  public $summary = null;
  public $hyperlink = null;

  /**
  * @var string Who published this Blog
  */
  public $author = null;
  ...
  */
  ...
  /**
  * Returns an Blog object matching the given Blog ID
  *
  ...
  * @return Array|false A two-element array : results => array, a list of Blog objects; totalRows => Total number of Blogs
  */
  ...
  */
  ...
  public function insert() {
    ...
    // Does the Blog object already have an ID?
  ...
  */
  ...
  public function update() {
    ...
    // Does the Blog object have an ID?
