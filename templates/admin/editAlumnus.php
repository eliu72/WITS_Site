    ...
    <div class="row">
        ...
        <div class="col-10">
          ...
          <form action="admin.php?action=<?php echo $results['formAction']?>" method="post"  enctype="multipart/form-data" onsubmit="closeKeepAlive()">
                  <input type="hidden" name="alumnusId" value="<?php echo $results['alumnus']->id ?>"/>
          ...
          <?php } ?>
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">Alumna Name</label>
                </div>
                <div class="col-7">
                <input type="text" name="person" id="person" placeholder="Name of the alumna" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['alumnus']->person )?>" />
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">Alumna Past Position</label>
                </div>
                <div class="col-7">
                <textarea name="title" id="title" placeholder="Past position of the alumna" required maxlength="255" style="width:100%"><?php echo htmlspecialchars( $results['alumnus']->title )?></textarea>
                </div>
              </div>
              <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="summary" id="summary" placeholder="Brief description of the alumna" required maxlength="500" style="width:100%;height: 5em;"><?php echo htmlspecialchars( $results['alumnus']->summary )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="url" id="url" placeholder="URL to their LinkedIn or website" required maxlength="500" style="width:100%; height: 5em;"><?php echo htmlspecialchars( $results['alumnus']->url )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="author" id="author" placeholder="Your name" required maxlength="255" style="width:100%;"><?php echo htmlspecialchars( $results['alumnus']->author )?></textarea>
                </div>
              </div>
              <br>

              <?php if ( $results['alumnus'] && $imagePath = $results['alumnus']->getImagePath() ) { ?>
                ...
                <div class="row mx-auto">
                  ...
                  <div class="col-2">
                  <img id="alumnusImage" src="<?php echo $imagePath ?>" alt="Alumna Image" style="width:150px;"/>
                  </div>
                  <div class="col-2 my-auto">
            ...
            <?php if ( $results['alumnus']->id ) { ?>
                  <p><a href="admin.php?action=deleteAlumnus&amp;alumnusId=<?php echo $results['alumnus']->id ?>" onclick="return confirm('Delete This Alumnus?')"><h3><b>Delete This Alumna</b></h3></a></p>
            <?php } ?>
          </div>
        </div>
      </div>
