    ...
    <div class="row">
        ...
        <div class="col-10">
          ...
          <form action="admin.php?action=<?php echo $results['formAction']?>" method="post"  enctype="multipart/form-data" onsubmit="closeKeepAlive()">
              <input type="hidden" name="testimonialId" value="<?php echo $results['testimonial']->id ?>"/>
          <?php if ( isset( $results['errorMessage'] ) ) { ?>
                  <div class="errorMessage"><?php echo $results['errorMessage'] ?></div>
          <?php } ?>
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">Testimonial Person</label>
                </div>
                <div class="col-7">
                <input type="text" name="person" id="person" placeholder="Name" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['testimonial']->person )?>" />
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">Their Position</label>
                </div>
                <div class="col-7">
                <input type="text" name="title" id="title" placeholder="Position" required maxlength="255" style="width:100%;" value="<?php echo htmlspecialchars( $results['testimonial']->title )?>" />
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="title">Their Testimonial</label>
                </div>
                <div class="col-7">
                <textarea name="summary" id="summary" placeholder="Their testimonial" required maxlength="500" style="width:100%; height: 5em;"><?php echo htmlspecialchars( $results['testimonial']->summary )?></textarea>
                </div>
              </div>
              <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="author" id="author" placeholder="Your name" required maxlength="255" style="width:100%;"><?php echo htmlspecialchars( $results['testimonial']->author )?></textarea>
                </div>
              </div>
              <br>

              <?php if ( $results['testimonial'] && $imagePath = $results['testimonial']->getImagePath() ) { ?>
                ...
                <div class="row mx-auto">
                  ...
                  <div class="col-2">
                  <img id="testimonialImage" src="<?php echo $imagePath ?>" alt="Testimonial Image" style="width:150px;"/>
                  </div>
                  <div class="col-2 my-auto">
            ...
            <?php if ( $results['testimonial']->id ) { ?>
                  <p><a href="admin.php?action=deleteTestimonial&amp;testimonialId=<?php echo $results['testimonial']->id ?>" onclick="return confirm('Delete This Testimonial?')"><h3><b>Delete This Testimonial</b></h3></a></p>
            <?php } ?>
          </div>
        </div>
      </div>
