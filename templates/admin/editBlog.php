    ...
    <div class="row">
        ...
        <div class="col-10">
          ...
          <form action="admin.php?action=<?php echo $results['formAction']?>" method="post"  enctype="multipart/form-data" onsubmit="closeKeepAlive()">
                  <input type="hidden" name="blogId" value="<?php echo $results['blog']->id ?>"/>
          ...
          <?php } ?>
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <input type="text" name="title" id="title" placeholder="Name of the blog" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['blog']->title )?>" />
                </div>
              </div>
                <br>
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="summary" id="summary" placeholder="Brief description of the blog" required maxlength="500" style="width:100%; height: 5em;"><?php echo htmlspecialchars( $results['blog']->summary )?></textarea>
                </div>
              </div>
                <br>
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="summary">Link to Blog</label>
                </div>
                <div class="col-7">
                <textarea name="hyperlink" id="hyperlink" placeholder="URL" required maxlength="255" style="width:100%"><?php echo htmlspecialchars( $results['blog']->summary )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="author" id="author" placeholder="Your name" required maxlength="255" style="width:100%;"><?php echo htmlspecialchars( $results['blog']->author )?></textarea>
                </div>
              </div>
              <br>

             <?php if ( $results['blog'] && $imagePath = $results['blog']->getImagePath() ) { ?>
                ...
                <div class="row mx-auto">
                  ...
                  <div class="col-2">
                  <img id="blogImage" src="<?php echo $imagePath ?>" alt="Blog Image" style="width:150px;"/>
                  </div>
                  <div class="col-2 my-auto">
            ...
            <?php if ( $results['blog']->id ) { ?>
                  <p><a href="admin.php?action=deleteBlog&amp;blogId=<?php echo $results['blog']->id ?>" onclick="return confirm('Delete This Blog?')"><h3><b>Delete This Blog</b></h3></a></p>
            <?php } ?>
          </div>
        </div>
      </div>
