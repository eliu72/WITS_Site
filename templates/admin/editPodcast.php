    ...
    <div class="row">
        ...
        <div class="col-10">
          ...
          <form action="admin.php?action=<?php echo $results['formAction']?>" method="post"  enctype="multipart/form-data" onsubmit="closeKeepAlive()">
                  <input type="hidden" name="podcastId" value="<?php echo $results['podcast']->id ?>"/>
          ...
          <?php } ?>
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <input type="text" name="title" id="title" placeholder="Name of the podcast" required autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['podcast']->title )?>" />
                </div>
              </div>
                <br>
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="summary" id="summary" placeholder="Brief description of the podcast" required maxlength="500" style="width:100%; height: 5em;"><?php echo htmlspecialchars( $results['podcast']->summary )?></textarea>
                </div>
              </div>
                <br>
              <div class="row mx-auto">
                <div class="col-2 my-auto">
                  <label for="summary">Link to Podcast</label>
                </div>
                <div class="col-7">
                <textarea name="hyperlink" id="hyperlink" placeholder="URL" required maxlength="255" style="width:100%"><?php echo htmlspecialchars( $results['podcast']->summary )?></textarea>
                </div>
              </div>
                <br>
              ...
              <div class="row mx-auto">
                ...
                <div class="col-7">
                <textarea name="author" id="author" placeholder="Your name" required maxlength="255" style="width:100%;"><?php echo htmlspecialchars( $results['podcast']->author )?></textarea>
                </div>
              </div>
              <br>

             <?php if ( $results['podcast'] && $imagePath = $results['podcast']->getImagePath() ) { ?>
                ...
                <div class="row mx-auto">
                  ...
                  <div class="col-2">
                  <img id="podcastImage" src="<?php echo $imagePath ?>" alt="Podcast Image" style="width:150px;"/>
                  </div>
                  <div class="col-2 my-auto">
            ...
            <?php if ( $results['podcast']->id ) { ?>
                  <p><a href="admin.php?action=deletePodcast&amp;podcastId=<?php echo $results['podcast']->id ?>" onclick="return confirm('Delete This Podcast?')"><h3><b>Delete This Podcast</b></h3></a></p>
            <?php } ?>
          </div>
        </div>
      </div>
